...
var Stores = function () {
    ...
    var view_tbl;
    var view_url = base_url + prefix + '/stores';
    var list_url = base_url + prefix + '/stores/list';
    var table_id = '#stores_table';
    /////////////////// View //////////////////
    ///////////////U////////////////////////////
    var viewTable = function () {
        ...
        var columns = [
            ...
            {"data": "store_number", "orderable": true, "searchable": true},
        ...
        var ajaxFilter = function (d) {
            d.name = $('#name').val();
            d.store_number = $('#store_number').val();
        };
