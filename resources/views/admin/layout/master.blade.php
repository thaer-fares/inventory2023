...
<head>
    ...
    <!--begin::Page Vendors Styles(used by this page) -->
    <link href="assets/admin/plugins/custom/fullcalendar/fullcalendar.bundle.rtl.css" rel="stylesheet"/>
    <!--end::Page Vendors Styles -->

    <!--begin::Global Theme Styles(used by all pages) -->
    <link href="assets/admin/plugins/global/plugins.bundle.rtl.css" rel="stylesheet"/>
    <link href="assets/admin/css/style.bundle.rtl.css" rel="stylesheet"/>

    <!--end::Global Theme Styles -->

    <!--begin::Layout Skins(used by all pages) -->
    <link href="assets/admin/css/skins/header/base/light.rtl.css" rel="stylesheet"/>
    <link href="assets/admin/css/skins/header/menu/light.rtl.css" rel="stylesheet"/>
    <link href="assets/admin/css/skins/brand/dark.rtl.css" rel="stylesheet"/>
    <link href="assets/admin/css/skins/aside/dark.rtl.css" rel="stylesheet"/>
    ...
    <style>
        @media print {
            .kt-container *:not(.show-print,.show-print *),.hide-print {
...
<!-- end:: Header Mobile -->
<div class="kt-grid print kt-grid--hor kt-grid--root">
