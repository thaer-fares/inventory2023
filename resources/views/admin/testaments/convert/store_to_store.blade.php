        ...
        <div class="col-lg-12">
            ...
            <div class="kt-portlet">
                ...
                <form class="kt-form kt-form--label-right" id="frmEdit" method="post"
                      action="{{ route('admin.testaments.convert.store_to_store') }}">
                            ...
                            <div class="col-lg-6">
                                ...
                                <select class="form-control kt-selectpicker" name="testament" data-live-search="true">
                                    @foreach($testaments as $testament)
                                        <option value="{{$testament->id}}">{{$testament->item->name}}
                                            | {{ $testament->unit->name }} | {{ $testament->quantity }}
                                            - {{ $testament->user->username }} | المخزن: {{ $testament->store->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-lg-6">
