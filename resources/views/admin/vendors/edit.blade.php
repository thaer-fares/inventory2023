        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <span class="kt-subheader__breadcrumbs-separator"></span>
                    <a href="{{ route('admin.vendors.edit', ['id' => $info->id]) }}"
        ...
        <div class="col-lg-12">
            ...
            <div class="kt-portlet">
                ...
                <form class="kt-form kt-form--label-right" id="frmEdit" method="post"
                      action="{{ route('admin.vendors.edit', ['id' => $info->id]) }}">
                    <div class="kt-portlet__body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control" name="vendor_number" value="{{ $info->vendor_number }}"
